...
edata <- read.csv("[Path to beta values]\\20DTFsamples_rounded_beta_matrix_28Oct2022.csv', row.names = 1)

#reading design file 
ddata <- read.csv('[design file for methylation data path]\\design_DTF_ALL_het_18Jan2023_design_DTF67_EE.csv')

#read in detailed methylation file 
dmdata <- read.csv('[design file for methylation data path]\\20samples_detailed_info_DTFhet_18Jan2023.csv')
...
write.csv(design_methylation__data_no_lists, 
          '[merged experimental and design info path]\\20samples_detailed_and_design_info_DTFhet_with_rounded_beta_matrix18Jan2023.csv')
